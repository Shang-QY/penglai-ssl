...
int ssl3_get_record(SSL *s)
{
    ...
    do {
        ...
        if ((RECORD_LAYER_get_rstate(&s->rlayer) != SSL_ST_READ_BODY) ||
            ...
            rret = ssl3_read_n(s, SSL3_RT_HEADER_LENGTH,
                               ...
                               num_recs == 0 ? 1 : 0, &n);
            if (rret <= 0){
                eapp_print("[ssl3_get_record] Before 210\n");
            ...
            if (!PACKET_buf_init(&pkt, RECORD_LAYER_get_packet(&s->rlayer),
                                 RECORD_LAYER_get_packet_length(&s->rlayer))) {
                eapp_print("[ssl3_get_record] Before 219\n");
            ...
            if (!PACKET_get_net_2_len(&sslv2pkt, &sslv2len)
                ...
                eapp_print("[ssl3_get_record] Before 227\n");
            ...
            if (s->server && RECORD_LAYER_is_first_record(&s->rlayer)
                ...
                if (thisrr->length > SSL3_BUFFER_get_len(rbuf)
                    ...
                    eapp_print("[ssl3_get_record] Before 254\n");
                ...
                if (thisrr->length < MIN_SSL2_RECORD_LEN) {
                    eapp_print("[ssl3_get_record] Before 261\n");
                    SSLfatal(s, SSL_AD_DECODE_ERROR, SSL_F_SSL3_GET_RECORD,
                ...
                if (!PACKET_get_1(&pkt, &type)
                    ...
                    eapp_print("[ssl3_get_record] Before 276\n");
                    SSLfatal(s, SSL_AD_DECODE_ERROR, SSL_F_SSL3_GET_RECORD,
                             ERR_R_INTERNAL_ERROR);
                    return -1;
                }
                ...
                if (!s->first_packet && !SSL_IS_TLS13(s)
                    ...
                    if ((s->version & 0xFF00) == (version & 0xFF00)
                        ...
                        if (thisrr->type == SSL3_RT_ALERT) {
                             ...
                             * end.
                             */
                            eapp_print("[ssl3_get_record] Before 305\n");
                    ...
                    eapp_print("[ssl3_get_record] Before 315\n");
                ...
                if ((version >> 8) != SSL3_VERSION_MAJOR) {
                    if (RECORD_LAYER_is_first_record(&s->rlayer)) {
                        ...
                        if (strncmp((char *)p, "GET ", 4) == 0 ||
                            ...
                            eapp_print("[ssl3_get_record] Before 330\n");
                            SSLfatal(s, SSL_AD_NO_ALERT, SSL_F_SSL3_GET_RECORD,
                                     SSL_R_HTTP_REQUEST);
                            return -1;
                        } else if (strncmp((char *)p, "CONNE", 5) == 0) {
                            eapp_print("[ssl3_get_record] Before 335\n");
                            SSLfatal(s, SSL_AD_NO_ALERT, SSL_F_SSL3_GET_RECORD,
                        ...
                        eapp_print("[ssl3_get_record] Before 342\n");
                        SSLfatal(s, SSL_AD_NO_ALERT, SSL_F_SSL3_GET_RECORD,
                                 SSL_R_WRONG_VERSION_NUMBER);
                        return -1;
                    } else {
                        eapp_print("[ssl3_get_record] Before 347\n");
        ...
        if (more > 0) {
            ...
            if (rret <= 0){
                eapp_print("[ssl3_get_record] Before 427\n");
    ...
    if (enc_err == 0) {
        if (ossl_statem_in_error(s)) {
            ...
            eapp_print("[ssl3_get_record] Before 557\n");
            return -1;
        }
        if (num_recs == 1 && ossl_statem_skip_early_data(s)) {
            ...
            if (!early_data_count_ok(s, thisrr->length,
                ...
                eapp_print("[ssl3_get_record] Before 571\n");
                return -1;
            }
        ...
        eapp_print("[ssl3_get_record] Before 581\n");
        SSLfatal(s, SSL_AD_BAD_RECORD_MAC, SSL_F_SSL3_GET_RECORD,
    ...
    if (enc_err < 0) {
        if (ossl_statem_in_error(s)) {
            ...
            eapp_print("[ssl3_get_record] Before 664\n");
            return -1;
        }
        if (num_recs == 1 && ossl_statem_skip_early_data(s)) {
            /*
            ...
            if (!early_data_count_ok(s, first_rec_len,
                                     EARLY_DATA_CIPHERTEXT_OVERHEAD, 0)) {
                /* SSLfatal() already called */
                eapp_print("[ssl3_get_record] Before 680\n");
                return -1;
            }
    ...
    if (s->early_data_state == SSL_EARLY_DATA_READING) {
        ...
        if (thisrr->type == SSL3_RT_APPLICATION_DATA
            ...
            /* SSLfatal already called */
            eapp_print("[ssl3_get_record] Before 806\n");
            return -1;
        }
    }
